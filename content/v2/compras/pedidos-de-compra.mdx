...
## Fluxo detalhado
1. Acesse o menu Compras e abra Pedidos de Compra.
2. Use a busca/filtros da listagem para localizar registros.
7. Revise mensagens de validação antes de concluir.

## Campos e validações
- Consulte o PDF seção 6.2 para nomes de campos, obrigatoriedade, máscaras e exemplos específicos.
...
## Conteúdo detalhado (PDF 6.2 Pedidos de Compra)
