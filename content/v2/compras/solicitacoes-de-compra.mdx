...
## Fluxo detalhado
1. Acesse o menu Compras e abra Solicitações de Compra.
2. Use a busca/filtros da listagem para localizar registros.
7. Revise mensagens de validação antes de concluir.

## Campos e validações
- Consulte o PDF seção 6.1 para nomes de campos, obrigatoriedade, máscaras e exemplos específicos.
...
## Conteúdo detalhado (PDF 6.1 Solicitações de Compra)
