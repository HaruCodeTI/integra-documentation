...
## Fluxo detalhado
1. Acesse o menu Recursos Humanos e abra Benefícios.
7. Revise mensagens de validação antes de concluir.

## Campos e validações
- Consulte o PDF seção 10.2 para nomes de campos, obrigatoriedade, máscaras e exemplos específicos.
...
## Conteúdo detalhado (PDF 10.2 Benefícios)
