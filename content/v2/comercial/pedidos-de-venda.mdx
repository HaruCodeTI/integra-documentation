...
## Fluxo detalhado
1. Acesse o menu Comercial e abra Pedidos de Venda.
2. Use a busca/filtros da listagem para localizar registros.
7. Revise mensagens de validação antes de concluir.

## Campos e validações
- Consulte o PDF seção 7.1 para nomes de campos, obrigatoriedade, máscaras e exemplos específicos.
...
## Conteúdo detalhado (PDF 7.1 Pedidos de Venda)
