...
## Fluxo detalhado
1. Acesse o menu Cadastros e abra Checklist.
2. Use a busca/filtros da listagem para localizar registros.
7. Revise mensagens de validação antes de concluir.

## Campos e validações
- Consulte o PDF seção 2.11 para nomes de campos, obrigatoriedade, máscaras e exemplos específicos.
...
## Conteúdo detalhado (PDF 2.11 Checklist)
